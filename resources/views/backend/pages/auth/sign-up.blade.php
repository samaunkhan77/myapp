            ...
            <div class="max-w-464-px mx-auto w-100">
                ...
                <form action="#">
                    ...
                    <span class="icon top-50 translate-middle-y">
                        ...
                        <input type="text" id="name" class="form-control h-56-px bg-neutral-50 radius-12" placeholder="Enter Name">
                    </div>
                    <div class="icon-field mb-16">
                    <span class="icon top-50 translate-middle-y">
                        <iconify-icon icon="f7:person"></iconify-icon>
                    ...
                    <span class="icon top-50 translate-middle-y">
                        ...
                        <input type="email" id="email" class="form-control h-56-px bg-neutral-50 radius-12" placeholder="Email">
                    </div>
                    <div class="mb-20">
                    ...
                    <button type="submit" onclick="submitForm()" class="btn btn-primary text-sm btn-sm px-12 py-16 w-100 radius-12 mt-32"> Sign Up</button>
